...
public enum ErrorCode {
    ...
    ALREADY_REQUESTED_FOLLOW(400,"Bad Request","F002","이미 팔로우 요청을 보냈습니다."),
    ALREADY_FOLLOWING(400,"Bad Request","F003","이미 친구 상태입니다."),
    FOLLOW_ACCESS_DENIED(403,"Forbidden","F004","팔로우 권한 요청이 없습니다."),
    NOT_FRIEND(400,"Bad Request","F005","친구 관계가 아닙니다."),
    REQUEST_PROCESSED(400,"Bad Request","F006","이미 처리된 요청입니다."),
    BAD_REQUEST(400,"Bad Request","F007","잘못된 요청 형식입니다."),
    FOLLOW_REQUEST_NOT_FOUND(400,"Bad Request","F008","해당 팔로우 요청을 찾을 수 없습니다.");
